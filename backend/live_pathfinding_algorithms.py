...
async def livebfs(grid, websocket):
    ...
    while queue:
        ...
        if current == end_position:
            ...
            return nodes_visited, bfs_grid, bfs_time
...
async def livedfs(grid, websocket):
    start_time = time.perf_counter()
    start_position, end_position = (0, 0), (4, 4)
    grid.append_nodes()
    ...
    while stack:
        ...
        if current == end_position:
            ...
            return nodes_visited, dfs_grid, dfs_time
...
async def livedijkstra(grid, websocket):
    start_time = time.perf_counter()
    start_position, end_position = (0, 0), (4, 4)
    grid.append_nodes()
    unvisited = set()
    ...
    while unvisited:
        ...
        if current == end_position:
            ...
            return nodes_visited, dijkstra_grid, dijkstra_time
...
async def liveastar(grid, websocket):
    start_time = time.perf_counter()
    start_position, end_position = (0, 0), (4, 4)
    grid.append_nodes()
    unvisited = set()
    ...
    while unvisited:
        ...
        if current == end_position:
            ...
            return nodes_visited, astar_grid, astar_time
